...
const[showLecture, setShowLecture]=useState(false)
  ...
  return (
    <>{showLecture ? <VideoStreaming modalOff={setShowLecture} /> :
      <> {showdata ?
        <div className='home-container1'>
          <div className="slide-container">
            ...
            <div className='btn-box'>
              <button className='lecture' onClick={() => { handleVideo() }}>&#9654; {logoWidth > 100 && "Lecture"}</button>
          ...
          <div className='avatar'>
            ...
            <button className='btn-clse' onClick={() => { logout() }}><img src='./logout.png' /></button>
            <img src={avat} alt='' />
          </div>
